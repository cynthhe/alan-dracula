...
SELECT DISTINCT 
    CASE WHEN rank_number IS NULL THEN 'No rank'
        WHEN rank_number = 1 THEN 'Rookie'
        WHEN rank_number = 2 THEN 'Pro'
        WHEN rank_number = 3 THEN 'Champion'
        WHEN rank_number = 4 THEN 'Epic'
        WHEN rank_number = 5 THEN 'Legend'
        ELSE NULL
        END AS rank_number
