...
-- Create SEGMENT_NO_ACR_USER_JOURNEY view
CREATE OR REPLACE VIEW segment_no_acr_user_journey AS
WITH cna_journey AS 
(SELECT DISTINCT
    userid
    ,sessionid
...
-- Create SEGMENT_NO_ACR_USER_JOURNEY_TABLE table
CREATE TABLE SEGMENT_NO_ACR_USER_JOURNEY_TABLE AS
SELECT *
FROM segment_no_acr_user_journey;
 
-- Update SEGMENT_NO_ACR_USER_JOURNEY_TABLE table
TRUNCATE TABLE SEGMENT_NO_ACR_USER_JOURNEY_TABLE;
INSERT INTO SEGMENT_NO_ACR_USER_JOURNEY_TABLE 
SELECT *
FROM segment_no_acr_user_journey;
...
-- Create reporting view: SEGMENT_NO_ACR_USER_JOURNEY_VIEW
CREATE OR REPLACE VIEW segment_no_acr_user_journey_view AS
SELECT *
FROM prod_games.arcade.SEGMENT_NO_ACR_USER_JOURNEY_TABLE;

-- Looker permissions for reporting view
GRANT SELECT ON prod_games.reporting.segment_no_acr_user_journey_view TO looker_read;
