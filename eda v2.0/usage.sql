...
create or replace view arcade_dayofweek_usage as
select distinct
...
grant select on prod_games.reporting.arcade_dayofweek_usage to looker_read;
...
// Hour of the day usage

-- Hour of the day usage for all CNA users
create or replace view arcade_hourofday_usage as
select distinct
    submit_time::date as date
...
-- Looker permissions for reporting view
grant select on prod_games.reporting.arcade_hourofday_usage to looker_read;
